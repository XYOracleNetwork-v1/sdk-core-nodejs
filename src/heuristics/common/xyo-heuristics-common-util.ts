...
export const uniqueIterableToObject = (buffer: XyoIterableStructure): {[key: string]: any} => {
...
export const iterableObjectToArray = (buffer: XyoIterableStructure): IXyoHumanHeuristic[] => {
  const it = buffer.newIterator()
