...
export const addAllDefaults = () => {
  XyoHumanHeuristicResolver.addResolver(
    XyoObjectSchema.BLE_POWER_LEVEL.id,
    rssiAt1MResolver
  )
  XyoHumanHeuristicResolver.addResolver(
    XyoObjectSchema.EC_PUBLIC_KEY.id,
    secp256K1PublicKeyResolver
  )
  XyoHumanHeuristicResolver.addResolver(
    XyoObjectSchema.EC_SIGNATURE.id,
  ...
  XyoHumanHeuristicResolver.addResolver(
    XyoObjectSchema.PREVIOUS_HASH.id,
    previousHashResolver
  )
  XyoHumanHeuristicResolver.addResolver(
    XyoObjectSchema.BRIDGE_HASH_SET.id,
