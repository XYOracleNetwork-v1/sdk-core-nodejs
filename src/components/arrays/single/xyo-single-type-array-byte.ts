 ...
 * @Last modified time: Thursday, 30th August 2018 12:22:13 pm
...
export class XyoSingleTypeArrayByte extends XyoSingleTypeArrayBase {
  ...
  get id () {
    return XyoResult.withValue(Buffer.from([
      XyoSingleTypeArrayByte.creator.major,
      XyoSingleTypeArrayByte.creator.minor
    ]));
  }
  ...
  get sizeIdentifierSize() {
    return XyoResult.withValue(XyoSingleTypeArrayByte.creator.sizeOfBytesToGetSize);
  }
