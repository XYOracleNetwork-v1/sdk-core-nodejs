 ...
 * @Last modified time: Tuesday, 20th November 2018 3:50:16 pm
...
export function getSignerProvider(signerProviderType: SignerProviderType): XyoRsaShaSignerProvider {
  ...
  switch (signerProviderType) {
    case 'rsa-sha1':
      signerProvider = new XyoRsaShaSignerProvider("pkcs1-sha1")
      break
    case 'rsa-sha256':
      signerProvider = new XyoRsaShaSignerProvider("pkcs1-sha256")
      break
    default:
