...
import {
  ...
  IXyoBoundWitnessValidationOptions,
...
export interface IXyoResolvers {
  ...
  [IResolvers.PEER_TRANSPORT]: IXyoProvider<
    IXyoPeerTransport,
    IXyoPeerTransportConfig
  >
  [IResolvers.SIGNERS]: IXyoProvider<IXyoSigner[], undefined>
  [IResolvers.SERIALIZATION_SERVICE]: IXyoProvider<
  ...
  [IResolvers.BOUND_WITNESS_PAYLOAD_PROVIDER]: IXyoProvider<
    ...
    undefined
  >
  [IResolvers.BOUND_WITNESS_SUCCESS_LISTENER]: IXyoProvider<
    IXyoBoundWitnessSuccessListener,
    undefined
  >
  [IResolvers.BOUND_WITNESS_VALIDATOR]: IXyoProvider<
    XyoBoundWitnessValidator,
    IXyoBoundWitnessValidationOptions
  >
  [IResolvers.NETWORK_PROCEDURE_CATALOGUE]: IXyoProvider<
    IXyoNetworkProcedureCatalogue,
  ...
  [IResolvers.DISCOVERY_NETWORK]: IXyoProvider<
    ...
    IXyoDiscoveryConfig
  >
  [IResolvers.TRANSACTION_REPOSITORY]: IXyoProvider<
    IXyoTransactionRepository,
    undefined
  >
  [IResolvers.ABOUT_ME_SERVICE]: IXyoProvider<
    XyoAboutMeService,
    IXyoAboutMeConfig
  >
}
